...
function parseTokenUserId(decoded) {
...
async function isUserOrganizationActive(userId) {
    const rows = await db
                ...
                if (userId != null) {
                    ...
                    if (!active) {
                        return res.status(403).json({
                            ...
                            message: "Your organization is inactive. Access is denied. Please contact your administrator.",
                        });
                    }
                }
