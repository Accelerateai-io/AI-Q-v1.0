 ...
 */
const patchVendorSelfAttestationUserArchive = async (req, res) => {
    try {
        ...
        const orgIdRaw = user.organization_id;
        ...
        const isMissingCol = /user_archived_at|vendor_self_attestation_user_archive_log|does not exist|42703/i.test(msg);
