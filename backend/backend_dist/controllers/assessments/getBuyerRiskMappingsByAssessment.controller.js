...
const getBuyerRiskMappingsByAssessment = async (req, res) => {
    try {
        ...
        const frameworkMappingRows = buildBuyerCotsFrameworkMappingRows(cotsRow.vendor_risk_assessment_report, cotsRow.regulatory_requirments);
        res.status(200).json({
            success: true,
            data: {
                assessmentId,
