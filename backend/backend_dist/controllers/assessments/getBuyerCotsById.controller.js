...
function extractImplementationReadinessFromVendorReport(report) {
    ...
    let implementationReadinessGrade = rawLetter != null && String(rawLetter).trim() !== ""
...
const getBuyerCotsById = async (req, res) => {
    try {
        ...
        const data = {
            ...
            ...extractImplementationReadinessFromVendorReport(r.vendor_risk_assessment_report),
        };
        data.organizationalPortal = buildBuyerCotsOrganizationalPortalInsights({
            ...
            vendorRiskReport: {
                frameworkMapping: {
                    rows: buildBuyerCotsFrameworkMappingRows(r.vendor_risk_assessment_report, r.regulatory_requirments),
                },
            },
        });
