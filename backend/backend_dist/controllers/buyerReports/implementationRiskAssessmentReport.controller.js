 ...
 */
const implementationRiskAssessmentReport = async (req, res) => {
    try {
        ...
        const iraPayload = await generateImplementationRiskAssessmentReport(completeEnriched, dbRisksBlock, buyerValidationSnippet);
        const stored = {
            version: 1,
