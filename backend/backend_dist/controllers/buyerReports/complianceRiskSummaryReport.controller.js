 ...
 */
const complianceRiskSummaryReport = async (req, res) => {
    try {
        ...
        const crsPayload = await generateComplianceRiskSummaryReport(completeEnriched, dbRisksBlock, buyerValidationSnippet);
        const stored = {
            version: 1,
