import { EMAIL_BRAND_PRIMARY, EMAIL_PAGE_BG, emailSignatureCheckmarkHtml, } from "./emailBrand.js";
...
export function buildInviteUserEmailHtml(organizationName, role, confirmationLink) {
    return `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
      ...
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;background-color:#ffffff;border-radius:12px;">
        <tr>
          <td style="padding:40px;">
            <h1 style="margin:0 0 24px;font-size:22px;line-height:1.3;font-weight:700;color:${EMAIL_BRAND_PRIMARY};">Welcome to ${INVITE_MAIL_PLATFORM_NAME.replace("-", "&#8209;")}</h1>
