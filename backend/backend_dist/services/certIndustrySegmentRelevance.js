...
export const CERT_RELEVANCE_FRAMEWORKS_BY_SEGMENT = {
...
export function normalizeCertIndustrySegmentInput(raw) {
    const s = String(raw ?? "")
        .trim()
        .toLowerCase()
        .replace(/\s+/g, " ")
...
export function getRelevantCertificationFrameworkSet(segmentNormalized) {
